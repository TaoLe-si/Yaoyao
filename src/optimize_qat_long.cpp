...
W gradient{},m{},v{};
int steps=optimizer=="adam"?6000:1200;
for(int step=1;
step<=steps;
...
std::ofstream out("build/qat_long_"+std::to_string(role_mode)+"_"+std::to_string(data_seed)+"_"+std::to_string(exposure)+"_partition_"+std::to_string(split_shift)+"_"+std::to_string(seed)+".weights",std::ios::binary);
