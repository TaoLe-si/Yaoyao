...
#include "diagnose_margin_expand.cpp"
#undef main
#include <set>
#include <sstream>
#include <fstream>
...
}std::ofstream out("build/margin_expand_partition_"+std::to_string(split_shift)+"_"+std::to_string(seed)+".weights",std::ios::binary);
