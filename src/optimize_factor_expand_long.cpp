...
#include "diagnose_factor_expand.cpp"
#undef main
#include <set>
#include <sstream>
#include <fstream>
...
}std::ofstream out("build/factor_expand_long_partition_"+std::to_string(split_shift)+"_"+std::to_string(seed)+".weights",std::ios::binary);
