...
#define DIAGNOSTIC_PREFIX "yaoyao_batched_step_"
#endif
...
if(!preflight&&(control.stop||std::filesystem::exists("build/STOP_TRAINING"))){printf("STOP restored checkpoint retained; no updates\n");return 0;}
