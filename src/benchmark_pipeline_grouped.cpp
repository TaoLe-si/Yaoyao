...
int main(int argc,char**argv){try{
 ...
 const PipelineGroupedModel candidate(read_compact_bundle(path,hash));
 ...
 Trial base[2],cand[2];
 base[0]=bench(baseline,"stage_grouped_avx2_2thread");cand[0]=bench(candidate,"pipeline_avx2_2thread");
 cand[1]=bench(candidate,"pipeline_avx2_2thread");base[1]=bench(baseline,"stage_grouped_avx2_2thread");
