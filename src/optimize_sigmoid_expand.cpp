...
#include "diagnose_sigmoid_expand.cpp"
#undef main
#include <set>
#include <sstream>
#include <fstream>
...
}std::ofstream out("build/sigmoid_expand_partition_"+std::to_string(split_shift)+"_"+std::to_string(seed)+".weights",std::ios::binary);
